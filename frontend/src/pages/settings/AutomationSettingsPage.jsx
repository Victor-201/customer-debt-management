    ...
    return (
        <div className="min-h-screen bg-slate-50 p-6">
            <div className="max-w-4xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <span className="text-sm text-gray-400">Cài đặt</span>
                    <h1 className="text-3xl font-bold text-gray-800 flex items-center gap-3">
                        <Settings className="text-purple-500" />
                        Tự động hóa nhắc nợ
                    </h1>
                    <p className="text-gray-500 mt-2">Cấu hình và chạy hệ thống gửi email nhắc nợ tự động</p>
                </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <button
                                    ...
                                    disabled={isRunning}
                                    className="mt-4 flex items-center gap-2 px-6 py-3 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isRunning ? (
                                        <>
